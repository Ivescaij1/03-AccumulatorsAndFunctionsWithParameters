...
def run_test_sum_of_digits():
    ...
    # Test 2:
    expected = 12
    answer = sum_of_digits(2019)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 11
    answer = sum_of_digits(80111)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 29
    answer = sum_of_digits(362792)
...
def digits_in_cube(n):
    ...
    # ------------------------------------------------------------------
    cube = n ** 3
    cube_digits_sum = sum_of_digits(cube)

    return cube_digits_sum
...
def run_test_digits_in_power():
    ...
    # Test 2:
    expected = 45
    answer = digits_in_power(15, 7)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 61
    answer = digits_in_power(625, 5)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def digits_in_power(n, k):
    ...
    # ------------------------------------------------------------------
    power = n ** k
    power_digits = sum_of_digits(power)
